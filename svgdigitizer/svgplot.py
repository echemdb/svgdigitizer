    ...
    def axis_orientations(self):
        ...
        def score(horizontal, vertical):
            ...
            A = self._transformation(
                ...
                # The actual values might be scaled very differently, e.g., one axis being in μA and one axis in V. This leads to one axis (and its errors) being rescaled very heavily which can lead to problems in the QR decomposition, see #149.
